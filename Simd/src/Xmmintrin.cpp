...
void xmmintrin()
{
    ...
    */
    ...
    m128a = _mm_load_ss(&arrFloat4[0]);								// r0 = *p, r1 = 0.0; r2= 0.0; r3= 0.0
    m128a = _mm_load_ps1(&arrFloat4[0]);							// r0 = *p, r1 = *p, r2 = *p, r3 = *p
    m128a = _mm_load_ps(&arrFloat4[0]);								// r0 = p[0], r1 = p[1], r2 = p[2], r3 = p[3]
    m128a = _mm_loadr_ps(&arrFloat4[0]);							// r0 = p[3], r1 = p[2], r2 = p[1], r3 = p[0]
    m128a = _mm_loadu_ps(&arrFloat4[0]);							// r0 = p[0], r1 = p[1], r2 = p[2], r3 = p[3]
