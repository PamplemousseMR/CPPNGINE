...
void mmintrin()
{
	...
	*/
	...
	m64 = _m_from_int(in);
	in =  _m_to_int(m64);
	m64 = _m_packsswb(m64, m64);
	m64 = _m_packssdw(m64, m64);
	m64 = _m_packuswb(m64, m64);
	m64 = _m_punpckhbw(m64, m64);
	m64 = _m_punpckhwd(m64, m64);
	m64 = _m_punpckhdq(m64, m64);
	m64 = _m_punpcklbw(m64, m64);
	m64 = _m_punpcklwd(m64, m64);
	m64 = _m_punpckldq(m64, m64);
